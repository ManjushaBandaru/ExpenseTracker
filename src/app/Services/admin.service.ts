...
export class AdminService {
  ...
  getHighestCategoryPurchase():Observable<any>{    
    return this.http.get<any>('https://localhost:44319/api/expenses/GetHighestPurchaseCategory()')
  }

  getmonthlyBudgetReport(year: any, month:any):Observable<any>{
    return this.http.get<any>(`https://localhost:44319/api/expenses/GetBudgetReport?year=${year}&month=${month}`)
  }
